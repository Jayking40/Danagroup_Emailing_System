  ...
  return (
    <section className="min-h-screen flex w-full">
      ...
      <div className="shadow-xl h-screen w-full flex justify-center items-center relative ">
        ...
        {/* form */}
        <div className="shadow-md h-[80%] w-[70%] z-20 bg-white flex flex-col px-16 gap-10 py-20 rounded">
          <div className="">
          ...
          <div className=" flex flex-col gap-4 ">
            <Input  title="Your Email" placeholder="Enter your email"/>
          ...
          <div>
            <Button label="Login" btnStyle="py-2 bg-black/95 w-full text-white rounded" />
          </div>
        </div>
        ...
        <div className="absolute top-[4vh] left-[2vw] h-24 w-24 rounded-lg bg-gradient-to-br from-red-600 via-blue-800 to-blue-400 p-[4px]">
