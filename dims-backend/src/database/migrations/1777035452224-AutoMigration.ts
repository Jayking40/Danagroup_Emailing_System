...
export class AutoMigration1777035452224 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "departments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "subsidiary_id" uuid NOT NULL, CONSTRAINT "UQ_e947363ef8ab521cf9cc530cedc" UNIQUE ("name", "subsidiary_id"), CONSTRAINT "PK_839517a681a86bb84cbcc6a1e9d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."announcements_target_enum" AS ENUM('all', 'subsidiary', 'department')`);
        ...
        await queryRunner.query(`CREATE TABLE "user_thread_state" ("id" SERIAL NOT NULL, "user_id" uuid NOT NULL, "thread_id" uuid NOT NULL, "unread_count" integer NOT NULL DEFAULT '0', "is_starred" boolean NOT NULL DEFAULT false, "is_read" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_26ac1226166cf144f95f885b699" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_88500ce10bcadc40f9264cc90f" ON "user_thread_state" ("user_id", "thread_id") `);
        await queryRunner.query(`CREATE TABLE "threads" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "subject" character varying(500) NOT NULL, "snippet" text, "last_activity_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "last_message_at" TIMESTAMP, CONSTRAINT "PK_d8a74804c34fc3900502cd27275" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e19b8c94e6afc03c66622dc7dc" ON "threads" ("last_activity_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_0973d3108a6a262459cdd7f305" ON "threads" ("last_message_at") `);
        ...
        await queryRunner.query(`CREATE TABLE "messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "thread_id" uuid NOT NULL, "sender_id" uuid NOT NULL, "subject" character varying(500) NOT NULL, "body" text NOT NULL, "body_html" text, "is_draft" boolean NOT NULL DEFAULT false, "sent_at" TIMESTAMP WITH TIME ZONE, "sender_deleted_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_55e5b3d0811df1361924239537" ON "messages" ("thread_id", "sent_at") `);
        await queryRunner.query(`CREATE TYPE "public"."message_recipients_type_enum" AS ENUM('to', 'cc', 'bcc')`);
        await queryRunner.query(`CREATE TABLE "message_recipients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."message_recipients_type_enum" NOT NULL DEFAULT 'to', "is_read" boolean NOT NULL DEFAULT false, "is_starred" boolean NOT NULL DEFAULT false, "is_deleted" boolean NOT NULL DEFAULT false, "is_permanently_deleted" boolean NOT NULL DEFAULT false, "deleted_at" TIMESTAMP WITH TIME ZONE, "is_archived" boolean NOT NULL DEFAULT false, "read_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "message_id" uuid NOT NULL, "recipient_id" uuid NOT NULL, CONSTRAINT "PK_e402cb51e37423da8d8a94cb3e0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum" AS ENUM('new_mail', 'announcement', 'system')`);
        ...
        await queryRunner.query(`ALTER TABLE "user_thread_state" ADD CONSTRAINT "FK_32260684eea0336fa62896068e7" FOREIGN KEY ("thread_id") REFERENCES "threads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "FK_bb3af7f695d50083e6523290d41" FOREIGN KEY ("thread_id") REFERENCES "threads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "message_recipients" ADD CONSTRAINT "FK_bc31fcc7f886e82e62eae8a162f" FOREIGN KEY ("recipient_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "message_recipients" DROP CONSTRAINT "FK_bc31fcc7f886e82e62eae8a162f"`);
        ...
        await queryRunner.query(`ALTER TABLE "user_thread_state" DROP CONSTRAINT "FK_32260684eea0336fa62896068e7"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."message_recipients_type_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_55e5b3d0811df1361924239537"`);
        await queryRunner.query(`DROP TABLE "messages"`);
        await queryRunner.query(`DROP TABLE "attachments"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0973d3108a6a262459cdd7f305"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e19b8c94e6afc03c66622dc7dc"`);
        await queryRunner.query(`DROP TABLE "threads"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_88500ce10bcadc40f9264cc90f"`);
        await queryRunner.query(`DROP TABLE "user_thread_state"`);
